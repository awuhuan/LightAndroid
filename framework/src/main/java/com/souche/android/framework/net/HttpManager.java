...
public class HttpManager {
    ...
    static {
        ...
        PersistentCookieStore cookieStore = new PersistentCookieStore(IocContainer.getShare().getApplicationContext()); //TODO:从缓存加载
        ...
        sHttpClient.getCookieSpecs().register("souche", csf);
        sHttpClient.getParams().setParameter(ClientPNames.COOKIE_POLICY,"souche");
